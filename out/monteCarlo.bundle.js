...
var Allocation = class extends ae {
  ...
  formatter;
  render() {
    return /* @__PURE__ */ me("div", null, /* @__PURE__ */ me("h1", null, "Portfolio Drawdown Monte Carlo Simulation"), /* @__PURE__ */ me("h2", null, "Portfolio Allocation"), /* @__PURE__ */ me("ul", null, /* @__PURE__ */ me("li", null, /* @__PURE__ */ me("label", {
...
var MonteCarlo = class {
  ...
  async computeSimulation(simulationConfig) {
    ...
    if (!this.historicalData) {
      if ("Deno" in window) {
        ...
        this.historicalData = await (await fetch("./data/historicalMarketData.json")).json();
      }
    }
    let total;
    let error;
  ...
  simulateDrawdown(simulationConfig, historicalData) {
    ...
    for (let y2 = 0; y2 < simulationConfig.simulationYears; y2++) {
      trials[y2] = {};
    }
